...
//   var menuIcon = $('.header-menu__icon').children();
//   $('.header-menu__icon').on('click', function () {
//      menuIcon.toggleClass('active');
//      $('body, .header__item-1, .header-menu__link').toggleClass('active');
//   });
//   $('.header-menu__link').on('click', function () {
//      menuIcon.removeClass('active');
//      $('body, .header__item-1, .header-menu__link').removeClass('active');
//   });
//});
